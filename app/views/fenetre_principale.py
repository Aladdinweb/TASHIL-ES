...
class FenetrePrincipale(ctk.CTk):
            ...
            if info is None:
                self.after(0, lambda:
                    messagebox.showinfo(
                        ...
                        "Pas de connexion."))
                return
            if version_plus_recente(info.get("tag","")):
                self.after(0, lambda:
    ...
    def _proposer_maj(self, info: dict):
        ...
        if not rep or not info.get("url_exe"):
            return
