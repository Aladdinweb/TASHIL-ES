...
a = Analysis(
    ...
    binaries=[],
    datas=[
        (os.path.join(BASE_DIR, 'app', 'assets'), 'app/assets'),
    ],
    hiddenimports=[
        'customtkinter',
        ...
        'app.utils.database', 'app.utils.theme',
        'app.utils.migration', 'app.utils.employes_dao',
        'app.utils.conges_dao', 'app.utils.bordereaux_dao',
        'app.utils.polycliniques_dao',
        'app.utils.deduction_engine',
        'app.utils.widgets_import',
        'app.views.fenetre_principale',
        'app.views.vue_dashboard', 'app.views.vue_employes',
        'app.views.vue_conges', 'app.views.vue_bordereaux',
        'app.views.vue_rollover', 'app.views.widgets',
...
exe = EXE(
    ...
    strip=False,
    upx=True,
    icon=os.path.join(BASE_DIR, 'app', 'assets', 'epsp_icon.ico'),
    console=False,
    onefile=True,
)
